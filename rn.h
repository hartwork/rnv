...
/* Pattern Bindings */
#define P_TYP(i) (rn_pattern[i]&0xFF)
...
#define P_FLG_ERS 0x40000000
#define P_FLG_MRK 0x80000000

#define marked(i) (rn_pattern[i]&P_FLG_MRK)
#define mark(i) (rn_pattern[i]|=P_FLG_MRK)
#define unmark(i) (rn_pattern[i]&=~P_FLG_MRK)

#define nullable(i) (rn_pattern[i]&P_FLG_NUL)
#define cdata(i) (rn_pattern[i]&P_FLG_TXT)
#define contentType(i) (rn_pattern[i]&0x1C00)
...
/* Name Class Bindings  */
#define NC_TYP(i) (rn_nameclass[i]&0xFF)
