...
#define nullable(i) (rn_pattern[i][0]&(0x10))
#define setNullable(i,x) if(x) rn_pattern[i][0]&=0x10
...
#define Element(i,nc,p1,r) P_IS(i,ELEMENT) \
   nc=rn_pattern[i][1]; p1=rn_pattern[i][2]; r=rn_pattern[i][3]
#define newElement(i,nc,p1,r) P_NEW(i,ELEMENT) \
   rn_pattern[i][1]=nc; rn_pattern[i][2]=p1; rn_pattern[i][3]=r
